// src/modules/transaction_workspace/hooks/useTransactionEngine.ts
/* eslint-disable @typescript-eslint/no-explicit-any */

import { useReducer } from "react";
import { generateId } from "@/core/identity/id.generator";
import { transactionReducer } from "@/engine/transaction/reducer/transaction.reducer";
import type {
    TransactionState,
    TransactionLineState,
} from "@/engine/transaction/types/transaction.types";
