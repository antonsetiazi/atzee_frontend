// src/core/ui/views/chat/components/ChatList.tsx
...
function getOtherUser(room: ChatRoom) {
    const currentUserId = "user_1"; // nanti ambil dari session
    return (
...
export default function ChatList({ rooms, activeRoom, onSelect }: Props) {
    return (
        <div className="h-full">
            {rooms.map((room) => {
                ...
                // 🔥 ambil status online
                const presence = chatStore.getPresence(otherUser);
